...
class SSLConnection(Connection):
    ...
    cert_reqs: Any
    ca_certs: Any
    def __init__(self, ssl_keyfile=..., ssl_certfile=..., ssl_cert_reqs=..., ssl_ca_certs=..., ssl_check_hostname: bool = ..., **kwargs) -> None:
        ...
...
class UnixDomainSocketConnection(Connection):
    ...
    encoding_errors: Any
    decode_responses: Any
    def __init__(self, path=..., db: int = ..., username=..., password=..., socket_timeout=..., encoding=..., encoding_errors=..., decode_responses=..., retry_on_timeout=..., parser_class=..., socket_read_size: int = ..., health_check_interval: int = ..., client_name=...) -> None:
        ...
