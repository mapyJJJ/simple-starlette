...
from typing import Any, Callable, Generic, Iterable, Iterator, Mapping, Sequence, Set, Text, Tuple, Type, Union, overload
...
class Redis(Generic[_StrType]):
    ...
    @overload
    @classmethod
    def from_url(cls, url: Text, host: Text | None = ..., port: int | None = ..., db: int | None = ..., password: Text | None = ..., socket_timeout: float | None = ..., socket_connect_timeout: float | None = ..., socket_keepalive: bool | None = ..., socket_keepalive_options: Mapping[str, int | str] | None = ..., connection_pool: ConnectionPool | None = ..., unix_socket_path: Text | None = ..., encoding: Text = ..., encoding_errors: Text = ..., charset: Text | None = ..., decode_responses: Literal[False] = ..., errors: Text | None = ..., retry_on_timeout: bool = ..., ssl: bool = ..., ssl_keyfile: Text | None = ..., ssl_certfile: Text | None = ..., ssl_cert_reqs: str | int | None = ..., ssl_ca_certs: Text | None = ..., ssl_check_hostname: bool = ..., max_connections: int | None = ..., single_connection_client: bool = ..., health_check_interval: float = ..., client_name: Text | None = ..., username: Text | None = ...) -> Redis[bytes]:
        ...
    
    connection_pool: Any
    response_callbacks: Any
    @overload
    def __new__(cls, host: Text, port: int, db: int, password: Text | None, socket_timeout: float | None, socket_connect_timeout: float | None, socket_keepalive: bool | None, socket_keepalive_options: Mapping[str, int | str] | None, connection_pool: ConnectionPool | None, unix_socket_path: Text | None, encoding: Text, encoding_errors: Text, charset: Text | None, decode_responses: Literal[True], errors: Text | None = ..., retry_on_timeout: bool = ..., ssl: bool = ..., ssl_keyfile: Text | None = ..., ssl_certfile: Text | None = ..., ssl_cert_reqs: str | int | None = ..., ssl_ca_certs: Text | None = ..., ssl_check_hostname: bool = ..., max_connections: int | None = ..., single_connection_client: bool = ..., health_check_interval: float = ..., client_name: Text | None = ..., username: Text | None = ...) -> Redis[str]:
        ...
    ...
    @overload
    def __init__(self: Redis[str], host: Text, port: int, db: int, password: Text | None, socket_timeout: float | None, socket_connect_timeout: float | None, socket_keepalive: bool | None, socket_keepalive_options: Mapping[str, int | str] | None, connection_pool: ConnectionPool | None, unix_socket_path: Text | None, encoding: Text, encoding_errors: Text, charset: Text | None, errors: Text | None, decode_responses: Literal[True], retry_on_timeout: bool = ..., ssl: bool = ..., ssl_keyfile: Text | None = ..., ssl_certfile: Text | None = ..., ssl_cert_reqs: str | int | None = ..., ssl_ca_certs: Text | None = ..., ssl_check_hostname: bool = ..., max_connections: int | None = ..., single_connection_client: bool = ..., health_check_interval: float = ..., client_name: Text | None = ..., username: Text | None = ...) -> None:
        ...
    ...
    @overload
    def __init__(self: Redis[bytes], host: Text = ..., port: int = ..., db: int = ..., password: Text | None = ..., socket_timeout: float | None = ..., socket_connect_timeout: float | None = ..., socket_keepalive: bool | None = ..., socket_keepalive_options: Mapping[str, int | str] | None = ..., connection_pool: ConnectionPool | None = ..., unix_socket_path: Text | None = ..., encoding: Text = ..., encoding_errors: Text = ..., charset: Text | None = ..., errors: Text | None = ..., decode_responses: Literal[False] = ..., retry_on_timeout: bool = ..., ssl: bool = ..., ssl_keyfile: Text | None = ..., ssl_certfile: Text | None = ..., ssl_cert_reqs: str | int | None = ..., ssl_ca_certs: Text | None = ..., ssl_check_hostname: bool = ..., max_connections: int | None = ..., single_connection_client: bool = ..., health_check_interval: float = ..., client_name: Text | None = ..., username: Text | None = ...) -> None:
        ...
    ...
    @overload
    def lock(self, name: _Key, timeout: float | None = ..., sleep: float = ..., blocking_timeout: float | None = ..., lock_class: None = ..., thread_local: bool = ...) -> Lock:
        ...
    
    @overload
    def lock(self, name: _Key, timeout: float | None, sleep: float, blocking_timeout: float | None, lock_class: Type[_LockType], thread_local: bool = ...) -> _LockType:
        ...
    ...
    def acl_setuser(self, username: Text = ..., enabled: bool = ..., nopass: bool = ..., passwords: Sequence[Text] | None = ..., hashed_passwords: Sequence[Text] | None = ..., categories: Sequence[Text] | None = ..., commands: Sequence[Text] | None = ..., keys: Sequence[Text] | None = ..., reset: bool = ..., reset_keys: bool = ..., reset_passwords: bool = ...) -> bool:
        ...
    ...
    def set(self, name: _Key, value: _Value, ex: None | int | timedelta = ..., px: None | int | timedelta = ..., nx: bool = ..., xx: bool = ..., keepttl: bool = ...) -> bool | None:
        ...
    ...
    def linsert(self, name: _Key, where: Literal["BEFORE", "AFTER", "before", "after"], refvalue: _Value, value: _Value) -> int:
        ...
    ...
    @overload
    def sort(self, name: _Key, start: int | None = ..., num: int | None = ..., by: _Key | None = ..., get: _Key | Sequence[_Key] | None = ..., desc: bool = ..., alpha: bool = ..., store: None = ..., groups: bool = ...) -> list[_StrType]:
        ...
    
    @overload
    def sort(self, name: _Key, start: int | None = ..., num: int | None = ..., by: _Key | None = ..., get: _Key | Sequence[_Key] | None = ..., desc: bool = ..., alpha: bool = ..., *, store: _Key, groups: bool = ...) -> int:
        ...
    ...
    def xclaim(self, name, groupname, consumername, min_idle_time, message_ids, idle=..., time=..., retrycount=..., force=..., justid=...):
        ...
    ...
    def zadd(self, name: _Key, mapping: Mapping[_Key, _Value], nx: bool = ..., xx: bool = ..., ch: bool = ..., incr: bool = ...) -> int:
        ...
    ...
    @overload
    def zrange(self, name: _Key, start: int, end: int, desc: bool = ..., *, withscores: Literal[True], score_cast_func: Callable[[float], _ScoreCastFuncReturn] = ...) -> list[Tuple[_StrType, _ScoreCastFuncReturn]]:
        ...
    
    @overload
    def zrange(self, name: _Key, start: int, end: int, desc: bool = ..., withscores: bool = ..., score_cast_func: Callable[[Any], Any] = ...) -> list[_StrType]:
        ...
    
    def zrangebylex(self, name: _Key, min: _Value, max: _Value, start: int | None = ..., num: int | None = ...) -> list[_StrType]:
        ...
    
    @overload
    def zrangebyscore(self, name: _Key, min: _Value, max: _Value, start: int | None = ..., num: int | None = ..., *, withscores: Literal[True], score_cast_func: Callable[[float], _ScoreCastFuncReturn] = ...) -> list[Tuple[_StrType, _ScoreCastFuncReturn]]:
        ...
    
    @overload
    def zrangebyscore(self, name: _Key, min: _Value, max: _Value, start: int | None = ..., num: int | None = ..., withscores: bool = ..., score_cast_func: Callable[[Any], Any] = ...) -> list[_StrType]:
        ...
    ...
    @overload
    def zrevrange(self, name: _Key, start: int, end: int, desc: bool = ..., *, withscores: Literal[True], score_cast_func: Callable[[float], _ScoreCastFuncReturn] = ...) -> list[Tuple[_StrType, _ScoreCastFuncReturn]]:
        ...
    
    @overload
    def zrevrange(self, name: _Key, start: int, end: int, desc: bool = ..., withscores: bool = ..., score_cast_func: Callable[[Any], Any] = ...) -> list[_StrType]:
        ...
    
    @overload
    def zrevrangebyscore(self, name: _Key, min: _Value, max: _Value, start: int | None = ..., num: int | None = ..., *, withscores: Literal[True], score_cast_func: Callable[[float], _ScoreCastFuncReturn] = ...) -> list[Tuple[_StrType, _ScoreCastFuncReturn]]:
        ...
    
    @overload
    def zrevrangebyscore(self, name: _Key, min: _Value, max: _Value, start: int | None = ..., num: int | None = ..., withscores: bool = ..., score_cast_func: Callable[[Any], Any] = ...) -> list[_StrType]:
        ...
    
    def zrevrangebylex(self, name: _Key, min: _Value, max: _Value, start: int | None = ..., num: int | None = ...) -> list[_StrType]:
        ...
...
class Pipeline(Redis[_StrType], Generic[_StrType]):
    ...
    def acl_cat(self, category: Text | None = ...) -> Pipeline[_StrType]:
        ...
    
    def acl_deluser(self, username: Text) -> Pipeline[_StrType]:
        ...
    
    def acl_genpass(self) -> Pipeline[_StrType]:
        ...
    
    def acl_getuser(self, username: Text) -> Pipeline[_StrType]:
        ...
    ...
    def acl_setuser(self, username: Text = ..., enabled: bool = ..., nopass: bool = ..., passwords: Sequence[Text] | None = ..., hashed_passwords: Sequence[Text] | None = ..., categories: Sequence[Text] | None = ..., commands: Sequence[Text] | None = ..., keys: Sequence[Text] | None = ..., reset: bool = ..., reset_keys: bool = ..., reset_passwords: bool = ...) -> Pipeline[_StrType]:
        ...
    ...
    def bgsave(self) -> Pipeline[_StrType]:
        ...
    
    def client_id(self) -> Pipeline[_StrType]:
        ...
    
    def client_kill(self, address: Text) -> Pipeline[_StrType]:
        ...
    
    def client_list(self) -> Pipeline[_StrType]:
        ...
    
    def client_getname(self) -> Pipeline[_StrType]:
        ...
    
    def client_setname(self, name: Text) -> Pipeline[_StrType]:
        ...
    ...
    def config_get(self, pattern=...) -> Pipeline[_StrType]:
        ...
    
    def config_set(self, name, value) -> Pipeline[_StrType]:
        ...
    ...
    def flushall(self) -> Pipeline[_StrType]:
        ...
    
    def flushdb(self) -> Pipeline[_StrType]:
        ...
    
    def info(self, section: _Key | None = ...) -> Pipeline[_StrType]:
        ...
    ...
    def bitcount(self, key: _Key, start: int | None = ..., end: int | None = ...) -> Pipeline[_StrType]:
        ...
    
    def bitop(self, operation, dest, *keys) -> Pipeline[_StrType]:
        ...
    
    def bitpos(self, key, bit, start=..., end=...) -> Pipeline[_StrType]:
        ...
    ...
    def expire(self, name: _Key, time: int | timedelta) -> Pipeline[_StrType]:
        ...
    
    def expireat(self, name, when) -> Pipeline[_StrType]:
        ...
    ...
    def pexpire(self, name: _Key, time: int | timedelta) -> Pipeline[_StrType]:
        ...
    
    def pexpireat(self, name: _Key, when: int | datetime) -> Pipeline[_StrType]:
        ...
    ...
    def restore(self, name, ttl, value, replace: bool = ...) -> Pipeline[_StrType]:
        ...
    
    def set(self, name: _Key, value: _Value, ex: None | int | timedelta = ..., px: None | int | timedelta = ..., nx: bool = ..., xx: bool = ..., keepttl: bool = ...) -> Pipeline[_StrType]:
        ...
    ...
    def lpop(self, name) -> Pipeline[_StrType]:
        ...
    ...
    def rpop(self, name) -> Pipeline[_StrType]:
        ...
    ...
    def scan(self, cursor: int = ..., match: _Key | None = ..., count: int | None = ...) -> Pipeline[_StrType]:
        ...
    
    def scan_iter(self, match: Text | None = ..., count: int | None = ...) -> Iterator[Any]:
        ...
    
    def sscan(self, name: _Key, cursor: int = ..., match: Text = ..., count: int = ...) -> Pipeline[_StrType]:
        ...
    
    def sscan_iter(self, name, match=..., count=...) -> Iterator[Any]:
        ...
    
    def hscan(self, name: _Key, cursor: int = ..., match: Text = ..., count: int = ...) -> Pipeline[_StrType]:
        ...
    
    def hscan_iter(self, name, match=..., count=...) -> Iterator[Any]:
        ...
    
    def zscan(self, name, cursor=..., match=..., count=..., score_cast_func=...) -> Pipeline[_StrType]:
        ...
    ...
    def xadd(self, name, fields, id=..., maxlen=..., approximate=...) -> Pipeline[_StrType]:
        ...
    ...
    def xgroup_create(self, name, groupname, id=..., mkstream=...) -> Pipeline[_StrType]:
        ...
    ...
    def xgroup_setid(self, name, groupname, id) -> Pipeline[_StrType]:
        ...
    ...
    def xinfo_stream(self, name) -> Pipeline[_StrType]:
        ...
    ...
    def xpending_range(self, name, groupname, min, max, count, consumername=...) -> Pipeline[_StrType]:
        ...
    ...
    def xtrim(self, name, maxlen, approximate=...) -> Pipeline[_StrType]:
        ...
    
    def zadd(self, name: _Key, mapping: Mapping[_Key, _Value], nx: bool = ..., xx: bool = ..., ch: bool = ..., incr: bool = ...) -> Pipeline[_StrType]:
        ...
    ...
    def zinterstore(self, dest: _Key, keys: Iterable[_Key], aggregate: Literal["SUM", "MIN", "MAX"] = ...) -> Pipeline[_StrType]:
        ...
    ...
    def zrange(self, name: _Key, start: int, end: int, desc: bool = ..., withscores: bool = ..., score_cast_func: Callable[[Any], Any] = ...) -> Pipeline[_StrType]:
        ...
    
    def zrangebylex(self, name: _Key, min: _Value, max: _Value, start: int | None = ..., num: int | None = ...) -> Pipeline[_StrType]:
        ...
    
    def zrangebyscore(self, name: _Key, min: _Value, max: _Value, start: int | None = ..., num: int | None = ..., withscores: bool = ..., score_cast_func: Callable[[Any], Any] = ...) -> Pipeline[_StrType]:
        ...
    
    def zrank(self, name: _Key, value: _Value) -> Pipeline[_StrType]:
        ...
    ...
    def zrevrange(self, name: _Key, start: int, end: int, desc: bool = ..., withscores: bool = ..., score_cast_func: Callable[[Any], Any] = ...) -> Pipeline[_StrType]:
        ...
    
    def zrevrangebyscore(self, name: _Key, min: _Value, max: _Value, start: int | None = ..., num: int | None = ..., withscores: bool = ..., score_cast_func: Callable[[Any], Any] = ...) -> Pipeline[_StrType]:
        ...
    
    def zrevrangebylex(self, name: _Key, min: _Value, max: _Value, start: int | None = ..., num: int | None = ...) -> Pipeline[_StrType]:
        ...
    
    def zrevrank(self, name: _Key, value: _Value) -> Pipeline[_StrType]:
        ...
    
    def zscore(self, name: _Key, value: _Value) -> Pipeline[_StrType]:
        ...
    
    def zunionstore(self, dest: _Key, keys: Iterable[_Key], aggregate: Literal["SUM", "MIN", "MAX"] = ...) -> Pipeline[_StrType]:
        ...
    ...
    def script_flush(self) -> Pipeline[_StrType]:
        ...
