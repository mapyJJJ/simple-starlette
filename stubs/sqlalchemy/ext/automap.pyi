...
class AutomapBase:
    ...
    classes: Any = ...
    @classmethod
    def prepare(cls, autoload_with: Optional[Any] = ..., engine: Optional[Any] = ..., reflect: bool = ..., schema: Optional[Any] = ..., classname_for_table: Optional[Any] = ..., collection_class: Optional[Any] = ..., name_for_scalar_relationship: Optional[Any] = ..., name_for_collection_relationship: Optional[Any] = ..., generate_relationship: Optional[Any] = ..., reflection_options: Any = ...) -> None: ...
