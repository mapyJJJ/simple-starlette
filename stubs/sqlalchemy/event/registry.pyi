...
class _EventKey:
    ...
    fn_wrap: Any = ...
    dispatch_target: Any = ...
    def __init__(self, target: Any, identifier: Any, fn: Any, dispatch_target: Any, _fn_wrap: Optional[Any] = ...) -> None:
        ...
    ...
    def base_listen(self, propagate: bool = ..., insert: bool = ..., named: bool = ..., retval: Optional[Any] = ..., asyncio: bool = ...) -> None:
        ...
