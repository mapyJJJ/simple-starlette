...
class InstanceEvents(event.Events):
    ...
    def refresh_flush(self, target: Any, flush_context: Any, attrs: Any) -> None:
        ...
...
class MapperEvents(event.Events):
    ...
    def before_insert(self, mapper: Any, connection: Any, target: Any) -> None:
        ...
    
    def after_insert(self, mapper: Any, connection: Any, target: Any) -> None:
        ...
    
    def before_update(self, mapper: Any, connection: Any, target: Any) -> None:
        ...
    
    def after_update(self, mapper: Any, connection: Any, target: Any) -> None:
        ...
    
    def before_delete(self, mapper: Any, connection: Any, target: Any) -> None:
        ...
    
    def after_delete(self, mapper: Any, connection: Any, target: Any) -> None:
        ...
...
class SessionEvents(event.Events):
    ...
    def after_transaction_create(self, session: Any, transaction: Any) -> None:
        ...
    
    def after_transaction_end(self, session: Any, transaction: Any) -> None:
        ...
    ...
    def after_soft_rollback(self, session: Any, previous_transaction: Any) -> None:
        ...
...
class AttributeEvents(event.Events):
    ...
    def append_wo_mutation(self, target: Any, value: Any, initiator: Any) -> None:
        ...
    
    def bulk_replace(self, target: Any, values: Any, initiator: Any) -> None:
        ...
    
    def remove(self, target: Any, value: Any, initiator: Any) -> None:
        ...
    
    def set(self, target: Any, value: Any, oldvalue: Any, initiator: Any) -> None:
        ...
    
    def init_scalar(self, target: Any, value: Any, dict_: Any) -> None:
        ...
    
    def init_collection(self, target: Any, collection: Any, collection_adapter: Any) -> None:
        ...
    
    def dispose_collection(self, target: Any, collection: Any, collection_adapter: Any) -> None:
        ...
...
class QueryEvents(event.Events):
    ...
    def before_compile_update(self, query: Any, update_context: Any) -> None:
        ...
    
    def before_compile_delete(self, query: Any, delete_context: Any) -> None:
        ...
