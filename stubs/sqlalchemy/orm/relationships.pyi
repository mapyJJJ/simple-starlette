...
from .interfaces import PropComparator as PropComparator, StrategizedProperty as StrategizedProperty
...
class RelationshipProperty(StrategizedProperty):
    ...
    back_populates: Any = ...
    backref: Any = ...
    def __init__(self, argument: Any, secondary: Optional[Any] = ..., primaryjoin: Optional[Any] = ..., secondaryjoin: Optional[Any] = ..., foreign_keys: Optional[Any] = ..., uselist: Optional[Any] = ..., order_by: bool = ..., backref: Optional[Any] = ..., back_populates: Optional[Any] = ..., overlaps: Optional[Any] = ..., post_update: bool = ..., cascade: bool = ..., viewonly: bool = ..., lazy: str = ..., collection_class: Optional[Any] = ..., passive_deletes: Any = ..., passive_updates: Any = ..., remote_side: Optional[Any] = ..., enable_typechecks: Any = ..., join_depth: Optional[Any] = ..., comparator_factory: Optional[Any] = ..., single_parent: bool = ..., innerjoin: bool = ..., distinct_target_key: Optional[Any] = ..., doc: Optional[Any] = ..., active_history: Any = ..., cascade_backrefs: Any = ..., load_on_pending: bool = ..., bake_queries: bool = ..., _local_remote_pairs: Optional[Any] = ..., query_class: Optional[Any] = ..., info: Optional[Any] = ..., omit_join: Optional[Any] = ..., sync_backref: Optional[Any] = ..., _legacy_inactive_history_style: bool = ...) -> None:
        ...
    ...
    class Comparator(PropComparator):
        prop: Any = ...
        def __init__(self, prop: Any, parentmapper: Any, adapt_to_entity: Optional[Any] = ..., of_type: Optional[Any] = ..., extra_criteria: Any = ...) -> None:
            ...
...
class JoinCondition:
    ...
    def __init__(self, parent_persist_selectable: Any, child_persist_selectable: Any, parent_local_selectable: Any, child_local_selectable: Any, primaryjoin: Optional[Any] = ..., secondary: Optional[Any] = ..., secondaryjoin: Optional[Any] = ..., parent_equivalents: Optional[Any] = ..., child_equivalents: Optional[Any] = ..., consider_as_foreign_keys: Optional[Any] = ..., local_remote_pairs: Optional[Any] = ..., remote_side: Optional[Any] = ..., self_referential: bool = ..., prop: Optional[Any] = ..., support_sync: bool = ..., can_be_synced_fn: Any = ...) -> None:
        ...
    ...
    def join_targets(self, source_selectable: Any, dest_selectable: Any, aliased: Any, single_crit: Optional[Any] = ..., extra_criteria: Any = ...):
        ...
