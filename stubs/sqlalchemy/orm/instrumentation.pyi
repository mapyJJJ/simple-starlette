...
instance_dict: Any
manager_of_class = ...
def register_class(class_: Any, finalize: bool = ..., mapper: Optional[Any] = ..., registry: Optional[Any] = ..., declarative_scan: Optional[Any] = ..., expired_attribute_loader: Optional[Any] = ..., init_method: Optional[Any] = ...):
    ...
