...
class UOWTransaction:
    ...
    def get_attribute_history(self, state: Any, key: Any, passive: Any = ...):
        ...
    
    def has_dep(self, processor: Any):
        ...
    
    def register_preprocessor(self, processor: Any, fromparent: Any) -> None:
        ...
    
    def register_object(self, state: Any, isdelete: bool = ..., listonly: bool = ..., cancel_delete: bool = ..., operation: Optional[Any] = ..., prop: Optional[Any] = ...):
        ...
    
    def register_post_update(self, state: Any, post_update_cols: Any) -> None:
        ...
    
    def filter_states_for_dep(self, dep: Any, states: Any):
        ...
    
    def states_for_mapper_hierarchy(self, mapper: Any, isdelete: Any, listonly: Any) -> None:
        ...
...
class ProcessAll(IterateMappersMixin, PostSortRec):
    ...
    isdelete: Any = ...
    fromparent: Any = ...
    def __init__(self, uow: Any, dependency_processor: Any, isdelete: Any, fromparent: Any) -> None:
        ...
...
class ProcessState(PostSortRec):
    ...
    isdelete: Any = ...
    state: Any = ...
    def __init__(self, uow: Any, dependency_processor: Any, isdelete: Any, state: Any) -> None:
        ...
