...
def string_or_unprintable(element: Any):
    ...

def clsname_as_plain_name(cls):
    ...

def method_is_overridden(instance_or_cls: Any, against_method: Any):
    ...
...
def create_proxy_methods(target_cls: Any, target_cls_sphinx_name: Any, proxy_cls_sphinx_name: Any, classmethods: Any = ..., methods: Any = ..., attributes: Any = ...):
    ...
...
class HasMemoized:
    ...
    @classmethod
    def memoized_instancemethod(cls, fn: Any):
        ...
...
def constructor_key(obj: Any, cls: Any):
    ...
...
def warn(msg: Any, code: Optional[Any] = ...) -> None:
    ...
...
def repr_tuple_names(names: Any):
    ...
