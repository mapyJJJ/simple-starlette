...
from .result import Result as Result, ResultMetaData as ResultMetaData, SimpleResultMetaData as SimpleResultMetaData, tuplegetter as tuplegetter
...
class BaseCursorResult:
    ...
    cursor_strategy: Any = ...
    connection: Any = ...
    def __init__(self, context: Any, cursor_strategy: Any, cursor_description: Any): ...
    @property
