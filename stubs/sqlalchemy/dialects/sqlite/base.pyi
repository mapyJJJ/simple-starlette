from ... import exc as exc, processors as processors, sql as sql, types as sqltypes, util as util
...
class _DateTimeMixin:
    def __init__(self, storage_format: Optional[Any] = ..., regexp: Optional[Any] = ..., **kw: Any) -> None: ...
    @property
...
class SQLiteDialect(default.DefaultDialect):
    ...
    native_datetime: Any = ...
    def __init__(self, isolation_level: Optional[Any] = ..., native_datetime: bool = ..., json_serializer: Optional[Any] = ..., json_deserializer: Optional[Any] = ..., _json_serializer: Optional[Any] = ..., _json_deserializer: Optional[Any] = ..., **kwargs: Any) -> None: ...
