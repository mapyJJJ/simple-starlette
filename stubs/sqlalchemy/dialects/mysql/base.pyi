...
class MySQLCompiler(compiler.SQLCompiler):
    ...
    def visit_mysql_match(self, element: Any, **kw: Any):
        ...
...
class MySQLDialect(default.DefaultDialect):
    ...
    isolation_level: Any = ...
    def __init__(self, isolation_level: Optional[Any] = ..., json_serializer: Optional[Any] = ..., json_deserializer: Optional[Any] = ..., is_mariadb: Optional[Any] = ..., **kwargs: Any) -> None:
        ...
    ...
    def get_sequence_names(self, connection: Any, schema: Optional[Any] = ..., **kw: Any):
        ...
