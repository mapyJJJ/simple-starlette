...
from ...util.concurrency import asynccontextmanager as asynccontextmanager, asyncio as asyncio, await_fallback as await_fallback, await_only as await_only
...
class AsyncAdapt_asyncmy_dbapi:
    ...
    pymysql: Any = ...
    paramstyle: str = ...
    def __init__(self, asyncmy: Any, pymysql: Any) -> None: ...
