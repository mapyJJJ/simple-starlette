...
from ...sql import compiler as compiler, expression as expression, sqltypes as sqltypes, visitors as visitors
...
class OracleCompiler(compiler.SQLCompiler):
    ...
    def visit_join(self, join: Any, from_linter: Optional[Any] = ..., **kwargs: Any): ...
...
class OracleDialect(default.DefaultDialect):
    ...
    def __init__(self, use_ansi: bool = ..., optimize_limits: bool = ..., use_binds_for_limits: Optional[Any] = ..., use_nchar_for_unicode: bool = ..., exclude_tablespaces: Any = ..., **kwargs: Any) -> None: ...
