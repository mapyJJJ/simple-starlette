...
from ... import exc as exc, pool as pool, processors as processors, util as util
...
from .base import ENUM as ENUM, INTERVAL as INTERVAL, OID as OID, PGCompiler as PGCompiler, PGDialect as PGDialect, PGExecutionContext as PGExecutionContext, PGIdentifierPreparer as PGIdentifierPreparer, REGCLASS as REGCLASS, UUID as UUID
...
class AsyncAdapt_asyncpg_connection(AdaptedConnection):
    ...
    readonly: bool = ...
    deferrable: bool = ...
    def __init__(self, dbapi: Any, connection: Any, prepared_statement_cache_size: int = ...) -> None: ...
    @property
    def autocommit(self): ...
    @autocommit.setter
...
class PGDialect_asyncpg(PGDialect):
    ...
    async def setup_asyncpg_json_codec(self, conn: Any): ...
    async def setup_asyncpg_jsonb_codec(self, conn: Any): ...
    def on_connect(self): ...
