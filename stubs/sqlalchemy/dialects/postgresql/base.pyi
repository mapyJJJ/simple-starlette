...
from ...engine import characteristics as characteristics, default as default, reflection as reflection
from ...sql import coercions as coercions, compiler as compiler, elements as elements, expression as expression, roles as roles, sqltypes as sqltypes
...
class ENUM(sqltypes.NativeForEmulated, sqltypes.Enum):
    ...
    class EnumGenerator(DDLBase):
        checkfirst: Any = ...
        def __init__(self, dialect: Any, connection: Any, checkfirst: bool = ..., **kwargs: Any) -> None: ...
...
class PGCompiler(compiler.SQLCompiler):
    def visit_colon_cast(self, element: Any, **kw: Any): ...
