...
class PGDialect_psycopg2(PGDialect):
    ...
    def __init__(self, use_native_unicode: bool = ..., client_encoding: Optional[Any] = ..., use_native_hstore: bool = ..., use_native_uuid: bool = ..., executemany_mode: str = ..., executemany_batch_page_size: int = ..., executemany_values_page_size: int = ..., **kwargs: Any) -> None: ...
