from ... import Identity as Identity, Sequence as Sequence, exc as exc, sql as sql, text as text, types as sqltypes, util as util
from ...engine import default as default, reflection as reflection
from ...sql import coercions as coercions, compiler as compiler, elements as elements, expression as expression, func as func, quoted_name as quoted_name, roles as roles
...
from ...util import compat as compat, update_wrapper as update_wrapper
...
class MSTypeCompiler(compiler.GenericTypeCompiler):
    ...
    def visit__BASETIMEIMPL(self, type_: Any, **kw: Any): ...
    def visit_time(self, type_: Any, **kw: Any): ...
...
class MSSQLCompiler(compiler.SQLCompiler):
    ...
    def visit_is_not_distinct_from_binary(self, binary: Any, operator: Any, **kw: Any): ...
...
class MSDialect(default.DefaultDialect):
    ...
    isolation_level: Any = ...
    def __init__(self, query_timeout: Optional[Any] = ..., use_scope_identity: bool = ..., schema_name: str = ..., isolation_level: Optional[Any] = ..., deprecate_large_types: Optional[Any] = ..., json_serializer: Optional[Any] = ..., json_deserializer: Optional[Any] = ..., legacy_schema_aliasing: Optional[Any] = ..., **opts: Any) -> None: ...
    ...
    def has_sequence(self, connection: Any, sequencename: Any, dbname: Any, owner: Any, schema: Any): ...
    def get_sequence_names(self, connection: Any, dbname: Any, owner: Any, schema: Any, **kw: Any): ...
