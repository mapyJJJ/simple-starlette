from . import annotation as annotation, coercions as coercions, operators as operators, roles as roles, schema as schema, sqltypes as sqltypes
...
from .visitors import InternalTraversal as InternalTraversal, TraversibleType as TraversibleType
...
class ScalarFunctionColumn(NamedColumn):
    ...
    name: Any = ...
    type: Any = ...
    def __init__(self, fn: Any, name: Any, type_: Optional[Any] = ...) -> None: ...
