from . import base as base, coercions as coercions, crud as crud, elements as elements, functions as functions, operators as operators, schema as schema, selectable as selectable, sqltypes as sqltypes
from .. import exc as exc, util as util
from .base import NO_ARG as NO_ARG, prefix_anon_map as prefix_anon_map
...
ExpandedState = namedtuple('ExpandedState', ['statement', 'additional_parameters', 'processors', 'positiontup', 'parameter_expansion'])
NO_LINTING: Any
...
class Compiled:
    ...
    can_execute: Any = ...
    string: Any = ...
    def __init__(self, dialect: Any, statement: Any, schema_translate_map: Optional[Any] = ..., render_schema_translate: bool = ..., compile_kwargs: Any = ...) -> None: ...
    def visit_unsupported_compilation(self, element: Any, err: Any) -> None: ...
    @property
    def sql_compiler(self) -> None: ...
    def process(self, obj: Any, **kwargs: Any): ...
    def construct_params(self, params: Optional[Any] = ..., extracted_parameters: Optional[Any] = ...) -> None: ...
    @property
    def params(self): ...
...
class TypeCompiler:
    ...
    def visit_unsupported_compilation(self, element: Any, err: Any, **kw: Any) -> None: ...
...
class SQLCompiler(Compiled):
    ...
    anon_map: Any = ...
    truncated_names: Any = ...
    def __init__(self, dialect: Any, statement: Any, cache_key: Optional[Any] = ..., column_keys: Optional[Any] = ..., for_executemany: bool = ..., linting: Any = ..., **kwargs: Any) -> None: ...
    @property
    ...
    def construct_params(self, params: Optional[Any] = ..., _group_number: Optional[Any] = ..., _check: bool = ..., extracted_parameters: Optional[Any] = ...): ...
    @property
    def params(self): ...
    def default_from(self): ...
    def visit_grouping(self, grouping: Any, asfrom: bool = ..., **kwargs: Any): ...
    def visit_select_statement_grouping(self, grouping: Any, **kwargs: Any): ...
    ...
    def visit_label(self, label: Any, add_to_result_map: Optional[Any] = ..., within_label_clause: bool = ..., within_columns_clause: bool = ..., render_label_as_label: Optional[Any] = ..., result_map_targets: Any = ..., **kw: Any): ...
    def visit_lambda_element(self, element: Any, **kw: Any): ...
    def visit_column(self, column: Any, add_to_result_map: Optional[Any] = ..., include_table: bool = ..., result_map_targets: Any = ..., **kwargs: Any): ...
    ...
    def visit_textclause(self, textclause: Any, add_to_result_map: Optional[Any] = ..., **kw: Any): ...
    def visit_textual_select(self, taf: Any, compound_index: Optional[Any] = ..., asfrom: bool = ..., **kw: Any): ...
    ...
    compile_state: Any = ...
    def visit_compound_select(self, cs: Any, asfrom: bool = ..., compound_index: Optional[Any] = ..., **kwargs: Any): ...
    def visit_unary(self, unary: Any, add_to_result_map: Optional[Any] = ..., result_map_targets: Any = ..., **kw: Any): ...
    def visit_is_true_unary_operator(self, element: Any, operator: Any, **kw: Any): ...
    def visit_is_false_unary_operator(self, element: Any, operator: Any, **kw: Any): ...
    def visit_not_match_op_binary(self, binary: Any, operator: Any, **kw: Any): ...
    def visit_not_in_op_binary(self, binary: Any, operator: Any, **kw: Any): ...
    def visit_empty_set_op_expr(self, type_: Any, expand_op: Any): ...
    def visit_empty_set_expr(self, element_types: Any) -> None: ...
    def visit_binary(self, binary: Any, override_operator: Optional[Any] = ..., eager_grouping: bool = ..., from_linter: Optional[Any] = ..., lateral_from_linter: Optional[Any] = ..., **kw: Any): ...
    ...
    def visit_not_contains_op_binary(self, binary: Any, operator: Any, **kw: Any): ...
    def visit_startswith_op_binary(self, binary: Any, operator: Any, **kw: Any): ...
    def visit_not_startswith_op_binary(self, binary: Any, operator: Any, **kw: Any): ...
    def visit_endswith_op_binary(self, binary: Any, operator: Any, **kw: Any): ...
    def visit_not_endswith_op_binary(self, binary: Any, operator: Any, **kw: Any): ...
    def visit_like_op_binary(self, binary: Any, operator: Any, **kw: Any): ...
    def visit_not_like_op_binary(self, binary: Any, operator: Any, **kw: Any): ...
    def visit_ilike_op_binary(self, binary: Any, operator: Any, **kw: Any): ...
    def visit_not_ilike_op_binary(self, binary: Any, operator: Any, **kw: Any): ...
    def visit_between_op_binary(self, binary: Any, operator: Any, **kw: Any): ...
    def visit_not_between_op_binary(self, binary: Any, operator: Any, **kw: Any): ...
    def visit_regexp_match_op_binary(self, binary: Any, operator: Any, **kw: Any) -> None: ...
    def visit_not_regexp_match_op_binary(self, binary: Any, operator: Any, **kw: Any) -> None: ...
    def visit_regexp_replace_op_binary(self, binary: Any, operator: Any, **kw: Any) -> None: ...
    def visit_bindparam(self, bindparam: Any, within_columns_clause: bool = ..., literal_binds: bool = ..., skip_bind_expression: bool = ..., literal_execute: bool = ..., render_postcompile: bool = ..., **kwargs: Any): ...
    def render_literal_bindparam(self, bindparam: Any, render_literal_value: Any = ..., **kw: Any): ...
    def render_literal_value(self, value: Any, type_: Any): ...
    def bindparam_string(self, name: Any, positional_names: Optional[Any] = ..., post_compile: bool = ..., expanding: bool = ..., escaped_from: Optional[Any] = ..., **kw: Any): ...
    execution_options: Any = ...
    ctes_recursive: bool = ...
    def visit_cte(self, cte: Any, asfrom: bool = ..., ashint: bool = ..., fromhints: Optional[Any] = ..., visiting_cte: Optional[Any] = ..., from_linter: Optional[Any] = ..., **kwargs: Any): ...
    def visit_table_valued_alias(self, element: Any, **kw: Any): ...
    def visit_table_valued_column(self, element: Any, **kw: Any): ...
    def visit_alias(self, alias: Any, asfrom: bool = ..., ashint: bool = ..., iscrud: bool = ..., fromhints: Optional[Any] = ..., subquery: bool = ..., lateral: bool = ..., enclosing_alias: Optional[Any] = ..., from_linter: Optional[Any] = ..., **kwargs: Any): ...
    ...
    def visit_values(self, element: Any, asfrom: bool = ..., from_linter: Optional[Any] = ..., **kw: Any): ...
    ...
    def visit_select(self, select_stmt: Any, asfrom: bool = ..., insert_into: bool = ..., fromhints: Optional[Any] = ..., compound_index: Optional[Any] = ..., select_wraps_for: Optional[Any] = ..., lateral: bool = ..., from_linter: Optional[Any] = ..., **kwargs: Any): ...
    ...
    def visit_table(self, table: Any, asfrom: bool = ..., iscrud: bool = ..., ashint: bool = ..., fromhints: Optional[Any] = ..., use_schema: bool = ..., from_linter: Optional[Any] = ..., **kwargs: Any): ...
    def visit_join(self, join: Any, asfrom: bool = ..., from_linter: Optional[Any] = ..., **kwargs: Any): ...
...
class StrSQLCompiler(SQLCompiler):
    def visit_unsupported_compilation(self, element: Any, err: Any, **kw: Any): ...
    ...
    def visit_regexp_match_op_binary(self, binary: Any, operator: Any, **kw: Any): ...
    def visit_not_regexp_match_op_binary(self, binary: Any, operator: Any, **kw: Any): ...
    def visit_regexp_replace_op_binary(self, binary: Any, operator: Any, **kw: Any): ...
...
class DDLCompiler(Compiled):
    ...
    def visit_create_column(self, create: Any, first_pk: bool = ..., **kw: Any): ...
    def create_table_constraints(self, table: Any, _include_foreign_key_constraints: Optional[Any] = ..., **kw: Any): ...
    def visit_drop_table(self, drop: Any, **kw: Any): ...
    def visit_drop_view(self, drop: Any, **kw: Any): ...
    def visit_create_index(self, create: Any, include_schema: bool = ..., include_table_schema: bool = ..., **kw: Any): ...
    ...
    def visit_create_sequence(self, create: Any, prefix: Optional[Any] = ..., **kw: Any): ...
    ...
    def visit_table_or_column_check_constraint(self, constraint: Any, **kw: Any): ...
...
class IdentifierPreparer:
    ...
    def format_constraint(self, constraint: Any, _alembic_quote: bool = ...): ...
    def truncate_and_render_index_name(self, name: Any, _alembic_quote: bool = ...): ...
    def truncate_and_render_constraint_name(self, name: Any, _alembic_quote: bool = ...): ...
    ...
    def format_label_name(self, name: Any, anon_map: Optional[Any] = ...): ...
    def format_column(self, column: Any, use_table: bool = ..., name: Optional[Any] = ..., table_name: Optional[Any] = ..., use_schema: bool = ..., anon_map: Optional[Any] = ...): ...
