...
class Pool(log.Identified):
    logging_name: Any = ...
    echo: Any = ...
    def __init__(self, creator: Any, recycle: int = ..., echo: Optional[Any] = ..., logging_name: Optional[Any] = ..., reset_on_return: bool = ..., events: Optional[Any] = ..., dialect: Optional[Any] = ..., pre_ping: bool = ..., _dispatch: Optional[Any] = ...) -> None:
        ...
